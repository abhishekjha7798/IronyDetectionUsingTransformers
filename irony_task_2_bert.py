# -*- coding: utf-8 -*-
"""irony task 2-bert.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1JgMZWlZmqPNMzP9OTufSlDI_0o5KTLAA
...
OUTPUT_DIR = '/content/drive/My Drive/ML/datasets/test_TaskA/'
...
train = pd.read_csv("/content/drive/My Drive/ML/datasets/test_TaskA/mtest.csv")
test = pd.read_csv("/content/drive/My Drive/ML/datasets/test_TaskA/mtrain.csv")
...
print(classification_report(test['label'], enc_labels, target_names=target_names))
